...
import 'package:socially/presentation/widgets/shimmer_posts.dart';
    ...
    return BlocListener<InternetCubit, InternetState>(
      ...
      listener: (context, state) {
        if (state is InternetDisconnected) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            MySnackBar(
              icon: const Icon(Icons.done, color: AppColors.success, size: 18),
                            ...
                            return Padding(
                              ...
                              child: LayoutBuilder(
                                ...
                                return ClipRRect(
                                  ...
                                  child: Container(
                                    width:
                                        maxWidth ? 800 : constraints.maxWidth,
